  ...
  return (
      <div>
        ...
        <div className={"grid grid-cols-2 xl:gap-[30px] gap-4 md:pb-[30px] pb-[100px]"}>
          <div
              className={"w-full lg:col-span-1 col-span-2 bg-[white] flex items-center rounded-xl relative md:p-[30px] ph:p-4 p-2"}>
            <div
          ...
          <div
              className={"w-full lg:col-span-1 col-span-2 bg-[white] rounded-xl flex justify-between items-start relative md:p-[30px] ph:p-4 p-2"}>
          ...
          <div
              className={"w-full lg:col-span-1 col-span-2 bg-[white] rounded-xl relative md:p-[30px] ph:p-4 p-2"}>
          ...
          <div className={"w-full lg:col-span-1 col-span-2 flex flex-col bg-[white] pt-[24px] rounded-xl relative"}>
            <div className={"flex justify-between items-center md:px-[30px] ph:px-4 px-2"}>
          ...
          <div className={"w-full col-span-2 col-span-2 py-[30px] bg-[white] rounded-xl md:p-[30px] ph:p-4 p-2"}>
            <LeaderBoard/>
          </div>

          <div
              className={"w-full col-span-2 removeHeaderBg col-span-2 bg-[white] rounded-xl md:p-[30px] ph:p-4 p-2"}>
